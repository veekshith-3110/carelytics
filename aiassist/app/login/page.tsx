...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center z-10" suppressHydrationWarning>
      {/* Video Background */}
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-primary/40 via-purple-500/30 to-pink-500/30" />
